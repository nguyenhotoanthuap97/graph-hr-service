...
public class EvaluateService {
  ...
  public void validateSimilarity() {
    ...
    allSims.forEach(sim -> {
      int requiredSkillCount = graphHRDAO.getRequiredSkillCount(sim.getSimilarityId().getEmployeeId(), sim.getSimilarityId().getProjectName());
      int matchedCount = graphHRDAO.getMatchedRatingCount(sim.getSimilarityId().getEmployeeId(), sim.getSimilarityId().getProjectName());
